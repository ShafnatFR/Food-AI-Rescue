    ...
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="p-6 shrink-0 bg-white z-10 flex justify-between items-center border-b border-gray-50 shadow-sm">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-orange-100 rounded-lg flex items-center justify-center text-primary">
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar p-6 space-y-8 pb-28">
          ...
          <div className="space-y-3">
            <div className="bg-red-50 border border-red-100 rounded-xl p-4">
              <div className="flex items-start gap-3 mb-2">
                ...
                <div>
                  <h4 className="font-bold text-red-600 text-sm">Peringatan Stok Rendah</h4>
                  <p className="text-red-400 text-xs">Stok rendah: Hanya tersisa 20 unit.</p>
                </div>
              </div>
              <Button variant="outline" className="h-8 py-0 text-xs text-red-500 border-red-200 bg-white w-full hover:bg-red-50">Lihat Detail</Button>
            </div>
            
            <div className="bg-orange-50 border border-orange-100 rounded-xl p-4">
              <div className="flex items-start gap-3 mb-2">
                 <div className="p-1 bg-orange-100 rounded-full text-orange-500"><AlertTriangle size={12} /></div>
                <div>
                  <h4 className="font-bold text-orange-600 text-sm">Masalah Kualitas</h4>
                  <p className="text-orange-400 text-xs">Masalah kualitas terdeteksi pada batch terbaru.</p>
                </div>
              </div>
              <Button variant="outline" className="h-8 py-0 text-xs text-orange-500 border-orange-200 bg-white w-full hover:bg-orange-50">Lihat Detail</Button>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="border border-gray-100 rounded-2xl p-4 shadow-sm bg-white">
               <div className="flex justify-between items-start mb-2">
                  <p className="text-xs text-gray-500">Penjualan Bulan Ini</p>
                  <Package size={14} className="text-orange-300" />
               </div>
               <h4 className="font-bold text-lg text-gray-900">Rp 25.000.000</h4>
               <p className="text-[10px] text-green-500 flex items-center gap-1 font-medium"><TrendingUp size={10} /> +12%</p>
            </div>
            <div className="border border-gray-100 rounded-2xl p-4 shadow-sm bg-white">
               <div className="flex justify-between items-start mb-2">
               ...
               <h4 className="font-bold text-lg text-gray-900">1,240</h4>
               <p className="text-[10px] text-green-500 flex items-center gap-1 font-medium"><TrendingUp size={10} /> +5%</p>
            </div>
             <div className="border border-gray-100 rounded-2xl p-4 shadow-sm bg-white">
               <div className="flex justify-between items-start mb-2">
               ...
               <h4 className="font-bold text-lg text-gray-900">850</h4>
               <p className="text-[10px] text-green-500 flex items-center gap-1 font-medium"><TrendingUp size={10} /> +8%</p>
            </div>
             <div className="border border-gray-100 rounded-2xl p-4 shadow-sm bg-white">
               <div className="flex justify-between items-start mb-2">
                  <p className="text-xs text-gray-500">Pelanggan Baru</p>
                  <Package size={14} className="text-green-300" />
               </div>
               <h4 className="font-bold text-lg text-gray-900">320</h4>
               <p className="text-[10px] text-green-500 flex items-center gap-1 font-medium"><TrendingUp size={10} /> +15%</p>
            </div>
          </div>
        </section>
          ...
          <div className="bg-white rounded-xl h-48 flex items-end justify-between gap-2 pt-8">
            {[40, 65, 45, 80, 55, 90, 30, 70, 50, 60, 45, 85].map((h, i) => (
              <div key={i} className="flex-1 flex flex-col items-center gap-2 group">
                <div 
                  className="w-full bg-orange-200 rounded-t-sm transition-all duration-300 group-hover:bg-primary"
                  style={{ height: `${h}%` }}
                ></div>
              </div>
            ))}
           ...
           <div className="flex gap-4 justify-center mt-6">
              <div className="flex items-center gap-2 text-[10px] text-gray-500">
                <div className="w-2 h-2 rounded-full bg-orange-400"></div> Elektronik
              </div>
              <div className="flex items-center gap-2 text-[10px] text-gray-500">
                <div className="w-2 h-2 rounded-full bg-blue-300"></div> Pakaian
              </div>
              <div className="flex items-center gap-2 text-[10px] text-gray-500">
                <div className="w-2 h-2 rounded-full bg-gray-300"></div> Rumah Tangga
              </div>
           </div>
        </section>
        ...
        <div className="fixed bottom-24 right-6 z-30">
           <Button className="w-auto h-14 rounded-full px-6 shadow-xl shadow-orange-200" onClick={() => navigate('UPLOAD_PRODUCT')}>
             + Tambah
           </Button>
        </div>
      </div>
...
export const PartnerInventory: React.FC<PartnerProps> = ({ navigate }) => {
  ...
  const products = [
    ...
    {
      id: 4,
      name: "Yoghurt Rendah Lemak",
      price: "Rp 18.000",
      stockPercent: 15,
      image: "https://picsum.photos/seed/yoghurt/200/200"
    }
  ];
  ...
  return (
    <div className="flex flex-col h-full bg-white">
      {/* Header */}
      <div className="p-6 pb-2 shrink-0 bg-white z-10 shadow-sm">
        <h1 className="text-xl font-bold text-center text-gray-900">Inventory</h1>
      </div>
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar p-6 space-y-6 pb-28">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-4 shadow-sm flex items-center justify-between">
           <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-full overflow-hidden border border-gray-100">
                <img src="https://picsum.photos/seed/person/200/200" alt="Profile" className="w-full h-full object-cover" />
              </div>
              <div>
                <h3 className="font-bold text-gray-900 text-sm">PT. Maju Bersama</h3>
        ...
        <div className="flex gap-3">
          <div className="relative flex-1">
             ...
             <input className="w-full bg-gray-50 border border-gray-100 rounded-xl pl-10 pr-4 py-3 text-sm focus:outline-none focus:border-primary" placeholder="Cari produk..." />
          </div>
          <Button className="w-auto px-6 rounded-xl text-sm" onClick={() => navigate('UPLOAD_PRODUCT')}>
        ...
        <div className="flex gap-2 overflow-x-auto no-scrollbar pb-1">
           {categories.map((cat) => (
             <button 
               ...
               className={`px-4 py-2 rounded-full text-xs font-medium whitespace-nowrap transition-colors ${activeCategory === cat ? 'bg-primary/20 text-primary-hover border border-primary/20' : 'bg-gray-50 text-gray-600 border border-transparent'}`}
             >
               {cat}
             </button>
           ))}
           ...
           {products.map((product) => (
             <div key={product.id} className="bg-white border border-gray-100 rounded-2xl p-4 shadow-sm flex items-center gap-4">
                ...
                <div className="flex-1">
                   ...
                   <p className="text-gray-500 text-xs mb-3">{product.price}</p>
                   
                   <div className="flex items-center gap-3">
                      <div className="flex-1 h-2 bg-gray-100 rounded-full overflow-hidden">
                         <div className="h-full bg-primary rounded-full" style={{ width: `${product.stockPercent}%` }}></div>
                      </div>
                      <span className="text-xs text-gray-600 font-medium whitespace-nowrap">{product.stockPercent}% Stok</span>
                   </div>
                </div>
             </div>
           ))}
...
export const PartnerTransactions: React.FC<PartnerProps> = ({ navigate }) => {
  return (
    <div className="flex flex-col h-full bg-white">
       <div className="p-6 shrink-0 bg-white z-10 border-b border-gray-50 flex items-center justify-between shadow-sm">
         <h1 className="text-xl font-bold text-gray-900 mx-auto">Transaksi</h1>
       </div>
       ...
       <div className="flex-1 overflow-y-auto p-6 space-y-8 no-scrollbar pb-28">
         ...
         <section>
           <div className="flex justify-between items-center mb-4">
             <h3 className="font-bold text-gray-900">Volume Transaksi Bulanan</h3>
           ...
           <div className="flex h-40 items-end gap-3">
             <div className="flex flex-col justify-between h-full text-[10px] text-gray-400 py-1">
               <span>Rp 3 Jt</span>
               <span>Rp 2 Jt</span>
               <span>Rp 1 Jt</span>
               <span>Rp 0 Jt</span>
             </div>
             <div className="flex-1 flex items-end justify-between gap-2 h-full border-b border-gray-100 pb-1">
                {[45, 60, 50, 75, 65, 85, 80].map((h, i) => (
                  <div key={i} className="flex-1 flex flex-col items-center gap-1 group">
                    <div 
                      className="w-full bg-orange-300 rounded-t-md transition-all group-hover:bg-primary"
                      style={{ height: `${h}%` }}
                    ></div>
                  </div>
                ))}
           ...
           <div className="space-y-6">
             {[
               ...
               <div key={i} className="flex items-center gap-4">
                 ...
                 <div className="flex-1">
                   <h4 className="font-bold text-gray-900 text-sm">{tx.name}</h4>
                 ...
                 <div className="text-right">
                   ...
                   <span className={`text-[10px] px-2 py-0.5 rounded-full ${
                     ...
                     tx.status === 'Gagal' ? 'bg-red-50 text-red-500' : 'bg-orange-50 text-orange-500'
                   }`}>
                     {tx.status}
                   </span>
                 </div>
            ...
            <div className="h-48 border-2 border-dashed border-gray-200 rounded-2xl flex flex-col items-center justify-center bg-gray-50 relative overflow-hidden group hover:bg-gray-100 transition-colors">
               {image ? (
                 <>
                   ...
                   <button onClick={() => setImage(null)} className="absolute top-2 right-2 bg-white/80 p-1 rounded-full"><X size={16} /></button>
                 </>
               ) : (
                 <>
                   <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-sm mb-3 text-gray-400">
                     <UploadCloud size={20} />
                   </div>
                   <span className="text-sm text-gray-500">Ukuran file maksimum: 5MB</span>
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full p-8 bg-white text-center">
       <div className="mb-6 relative">
          <div className="w-48 h-40 bg-blue-50 rounded-xl flex items-end justify-center pb-0 overflow-hidden">
             <div className="w-24 h-24 bg-blue-200 rounded-t-full relative top-2"></div>
             {/* Simple illustration representation */}
             <div className="absolute inset-0 flex items-center justify-center">
                <CheckCircle size={64} className="text-primary fill-white" />
             </div>
          </div>
       </div>
